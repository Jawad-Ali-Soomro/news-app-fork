...
const RequestCard = ({
  ...
  return (
    ...
    <td className="align-middle text-sm font-normal px-6 py-4 whitespace-nowrap text-left">
      {channelApprovalStatus==="ACCEPTED"&&<span className="text-xs py-1 px-2.5 leading-none text-center whitespace-nowrap align-baseline font-medium bg-green-200 text-green-600 rounded-full">Accepted</span>}
      {channelApprovalStatus==="REJECTED"&& <span className="text-xs py-1 px-2.5 leading-none text-center whitespace-nowrap align-baseline font-medium bg-red-200 text-red-600 rounded-full">Rejected</span>}
      {channelApprovalStatus==="PENDING"&&  <span className="text-xs py-1 px-2.5 leading-none text-center whitespace-nowrap align-baseline font-medium bg-yellow-200 text-yellow-600 rounded-full">Pending</span>}
    </td>
   ...
   <Button variant={"success"} isLoading={isAccepting} className="px-2 py-2" onClick={handleAccept}>Accept</Button>
    <Button variant={"danger"} isLoading={isRejecting} className="px-2 py-2" onClick={handleReject}>Decline</Button>
   </>} 
    </td>
  </tr>
  );
